...
import top.i7un.springboot.model.Role;
...
public interface UserMapper {
    ...
    @Results({
            ...
            @Result(column = "phone", property = "roles", javaType = List.class, many = @Many(select = "top.i7un.springboot.mapper.UserMapper.getRoleNameByPhone")),
    })
